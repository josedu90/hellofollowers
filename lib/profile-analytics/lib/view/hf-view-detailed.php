...
<div class="hfspa-dashboard hfspa-dashboard">
	...
	<div class="hfspa-dashboard-panel">
		...
		<div class="hfspa-dashboard-panel-content">
			...
			<form method="POST">
			<table boder="0" cellpadding="6" cellspacing="0" width="100%" class="hfspa-lightgrey-bg">
				<col width="15%"/>
				<col width="85%"/>
				<tr>
					<td>Period:</td>
					<td><input name="from_date" value="<?php echo esc_attr($first_date);?>" id="from_date"
					class="input-element center hfspa-datefield" /> <input name="to_date" value="<?php echo esc_attr($last_date);?>" id="to_date"
