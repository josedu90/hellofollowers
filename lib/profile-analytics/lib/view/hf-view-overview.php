...
<div class="hfspa-dashboard hfspa-dashboard">
	...
	<div class="hfspa-dashboard-panel">
		<div class="hfspa-dashboard-panel-title color1">
			...
			<h5>Last updated: <?php echo esc_attr($last_date); ?></h5>
		</div>
		...
		print '<h4>' . esc_html__( 'Total Followers', 'hellofollowers' ) . '</h4>';
		...
		if ($best_diff_network != "") {
			...
			print '<h4>' . esc_html__( 'Top New Followers', 'hellofollowers' ) . '</h4>';
		...
		if ($best_network != "") {
			print '<div class="hfspa-profile-text hfspa-float-right" style="margin-right: 20px; text-align: center;">';
			print '<h4>' . esc_html__( 'Best Profile', 'hellofollowers' ) . '</h4>';
		...
		foreach ( hellofollowers_followers()->active_social_networks() as $social ) {
			...
			print '<div class="hfspa-profile-card hfspa-profile-' . esc_attr($social) . '">';
			print '<div class="hfspa-profile-icon hfspa-bg-' . esc_attr($social) . '"><i class="hfspa-icon-' . esc_attr($social) . '"></i></div>';
			print '<div class="hfspa-profile-text">';
	...
	<div class="hfspa-dashboard-panel">
		...
		<div class="hfspa-dashboard-panel-content" id="hfspa-changes-graph"></div>
	</div>
</div>
